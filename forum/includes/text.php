...
<input type="button" id="lien" name="lien" value="Lien" onClick="javascript:bbcode('[url=http://]', '[/url]');return(false)" />
...
<img src="./images/smileys/choc.png" title="choc" alt="choc" onClick="javascript:smilies(':O');return(false)" />
